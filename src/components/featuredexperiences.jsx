    ...
    <div className="relative w-full">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-start pt-6 md:pt-16 lg:pt-32 px-4 md:px-10 lg:px-20">
        <div className="w-full text-white">
          ...
          <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-[48px] font-bold leading-tight md:leading-snug whitespace-normal mt-2 md:mt-10 lg:mt-20">
            京都嵐山で
          ...
          <p className="mt-3 md:mt-4 lg:mt-6 text-white font-bold text-xs md:text-sm lg:text-base xl:text-[20px] whitespace-normal leading-relaxed">
