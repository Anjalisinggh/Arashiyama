...
export default function Experiences() {
  ...
  useEffect(() => {
    ...
    return (
      <section className="relative py-12 md:py-20 lg:py-28  -mt-12 bg-[#0b0b0b] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 lg:px-2">
  
          
          <div className="text-center mb-10 md:mb-16 lg:mb-20">
            <h2 className="text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold inline-block relative px-4">
  
            それぞれ
              <span className="text-[#CB9E38] mx-1 md:mx-2">異なる魅力を持つ文化を体験</span>
              せよ
  
              <img
                src="/expline.png"
                alt=""
                className="absolute left-1/2 -translate-x-1/2 -bottom-2 md:-bottom-4 w-[200px] md:w-[300px] lg:w-[450px]"
              />
          ...
          >
            ...
            <div className="flex gap-4 md:gap-6 lg:gap-8 min-w-max pb-6 ">

              {data.map((item, index) => (
  
                <div
                  key={index}
                  className="flex flex-col md:flex-row bg-[#363636] opacity-80 w-[280px] md:w-[480px] lg:w-[560px]"
                >
                  ...
                  <img
                    src={item.img}
                    alt=""
                    className="w-full md:w-[260px] h-[200px] md:h-[400px] object-cover"
                  />
  
                  
                  <div className="p-4 md:p-6">
  
                    <p className="text-[#FFB100] text-sm md:text-base lg:text-[18px] font-semibold mb-2">
                      {item.subtitle}
                    </p>
  
                    <h3 className="text-[#FFB100] text-lg md:text-xl lg:text-[30px] font-bold mb-2 md:mb-3">
                      {item.title}
                    </h3>
  
                    <div className="w-40 md:w-60 h-[1px] bg-[#CB9E38] mb-2 md:mb-3"></div>
  
                    <p className="text-[#FFB100] text-xs md:text-sm lg:text-[14px] leading-relaxed mb-2 md:mb-3">
                      {item.descJp}
                    </p>
  
                    <p className="text-[#FFB100] text-xs md:text-sm lg:text-[12px] leading-relaxed">
                      {item.descEn}
                    </p>
