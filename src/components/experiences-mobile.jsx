    ...
    <section className="relative py-8 bg-[#0b0b0b] overflow-hidden md:hidden">
      ...
      <div className="relative max-w-full mx-auto px-4">
        ...
        <div className="text-start mb-8">
          <h2 className="text-white text-[30px] font-bold inline-block relative px-4">
            それぞれ<br />
            <span className="text-[#CB9E38] mx-1">異なる魅力を持つ</span>

            <br />
            <span className="text-[#CB9E38] ">文化を体験</span>
            <span className="mx-1">せよ</span>
            <img
              src="/expline.png"
              alt=""
